...
ERROR_MESSAGE = "**- أُووبـس! هنالك خطـأ!** \n\n**الخطـأ هـو -** : {} " \
            "\n\n**- الرجاء التواصل @JJPJB واعلامه بالخطـأ** " \
...
async def main(_, msg):
    await msg.reply(
        "**- اخـتـر تـلـيـثـون لاسـتـخـراج كـود تـيـرمـڪـس تـيـركـس **",
...
async def generate_session(bot, msg, telethon=False):
    ...
    text = "**- كـود تيرمكـس {}** \n\n{} \n\n**- تم الاستخـراج بواسطـة** @JJPJB\n**- تحياتـي ..  روجر** @JJPJB ".format("تليثـون" if telethon else "بايروجـرام", string_session)
